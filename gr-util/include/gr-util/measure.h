...
class SCOPY_GR_UTIL_EXPORT Measure
{
public:

	Measure(const float *buffer = NULL, size_t length = 0);
	virtual ~Measure();
...
class SCOPY_GR_UTIL_EXPORT TimeMeasure : public Measure {
...
public:
	TimeMeasure(const float *buffer = NULL, size_t length = 0);
	~TimeMeasure();
...
class SCOPY_GR_UTIL_EXPORT SpectralMeasure : public Measure {
