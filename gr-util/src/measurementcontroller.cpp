...
void TimeMeasureManager::initMeasure(QPen m_pen)
{
	...
	connect(m_measureController, &TimeChannelMeasurementController::measurementEnabled, this, &TimeMeasureManager::enableMeasurement);
	connect(m_measureController, &TimeChannelMeasurementController::measurementDisabled, this, &TimeMeasureManager::disableMeasurement);
	connect(m_measureController, &TimeChannelMeasurementController::statsEnabled, this, &TimeMeasureManager::enableStat);
	connect(m_measureController, &TimeChannelMeasurementController::statsDisabled, this, &TimeMeasureManager::disableStat);
...
MeasurementController *TimeMeasureManager::getController()
{
	return m_measureController;
}

MeasureModel *TimeMeasureManager::getModel()
{
	return m_measureModel;
}
...
QWidget* TimeMeasureManager::createMeasurementMenuSection(QString category, QWidget* parent) {
	...
	connect(this, &MeasureManagerInterface::toggleAllMeasurement, measureSelector, &MeasurementSelector::toggleAllMeasurement);
